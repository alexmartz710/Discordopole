    ...
    async def board_loop(self):
        ...
        for board in self.bot.boards['stats']:
            try:
                ...
                if ("raid_active" or "raid_lvl_1_active" or "raid_lvl_2_active" or "raid_lvl_3_active" or "raid_lvl_4_active" or "raid_lvl_5_active" or "raid_lvl_6_active" or "raid_lvl_7_active") in board['type']:
                ...
                if ("egg_active" or "egg_lvl_1_active" or "egg_lvl_2_active" or "egg_lvl_3_active" or "egg_lvl_4_active" or "egg_lvl_5_active" or "egg_lvl_6_active" or "egg_lvl_7_active") in board['type']:
