    ...
    async def board_loop(self):
        ...
        for board in self.bot.boards['stats']:
            try:
                ...
                if ("raid_active" or "raid_lvl_1_active" or "raid_lvl_2_active" or "raid_lvl_3_active" or "raid_lvl_4_active" or "raid_lvl_5_active" or "raid_lvl_6_active" or "raid_lvl_7_active" or "raid_lvl_8_active") in board['type']:
                    ...
                    if "raid_lvl_7_active" in board['type'] and not "egg_lvl_7_active" in board['type']:
                        text = f"{text}7⭐ **{raid_active[0][7]:,}** {self.bot.locale['raids']}\n"
