...
class Admin(commands.Cog):
    ...
    async def raid(self, ctx, area, levels):
        ...
        if all(i > 7 or i < 1 for i in level_list):
    ...
    async def emotes(self, ctx, quick_name=""):
        ...
        needed_emote_names = ["ex_pass", "raid_egg_1", "raid_egg_3", "raid_egg_5", "raid_egg_6", "raid_egg_7", "gym_blue", "gym_red", "gym_yellow", "gym_white", "gym_grey", "blank", "raid", "cliff", "grunt_female", "pokeball", "pokestop", "lure", "lure_normal", "lure_glacial", "lure_mossy", "lure_magnetic", "lure_rainy"]
